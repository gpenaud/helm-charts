...
{{- if .Values.alterconso.serviceAccount.create }}
{{- default (include "alterconso.fullname" .) .Values.alterconso.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.alterconso.serviceAccount.name }}
{{- end }}
{{- end }}
